...
class AssignDupe extends MooshCommand
{
	...
	foreach ( $submits as $submit ) {
		...
		$timecreated = $submit->timecreated;
		$timemodified = $submit->timemodified;
		$date_format = "Y-m-d H:i";
		echo date($date_format, $timecreated) . " " . date($date_format, $timemodified) . " " . $submit->firstname . "\t" . $submit->lastname . " " . "$cleaned\n\n";
	}
